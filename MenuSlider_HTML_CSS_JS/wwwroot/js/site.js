...
const indicador = document.getElementById('indicador_id');//especificamos el id del identificador
//va a contener todas las secciones que tiene mi pagina con "querySelectorAll"
const secciones = document.querySelectorAll('.seccion, #Inicio, #Contacto');//ADJUNTAR TODAS NUESTRAS SECCIONES SIN IMPORTAR EL TIPO TENER CUIDADO
